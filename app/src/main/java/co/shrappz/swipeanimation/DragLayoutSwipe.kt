...
class DragLayoutSwipe : RelativeLayout {
    ...
    inner class DragHelperCallback : ViewDragHelper.Callback() {
        ...
        override fun clampViewPositionHorizontal(child: View, left: Int, dx: Int): Int {
            val layoutParams = (mDragView.findViewById<View>(R.id.round_icon).layoutParams as (RelativeLayout.LayoutParams))
            val leftBound = paddingLeft+layoutParams.marginStart
            val rightBound = width - (mDragView.findViewById<View>(R.id.round_icon).width + layoutParams.marginStart +layoutParams.marginEnd)
